...
@section('content')
<div class="bg-user-polka text-center c-pad">
  <div class="row">
    <h1 class="col-md-12 fw-bold" style="font-size: 5rem; margin-top: 4rem;">Exclusive Member</h1>
    <p class="fs-4">Everything you need to reach your career goals.</p>
  </div>
  ...
  <div class="container c-mar">
    ...
    <div class="row gy-5 align-items-center justify-content-center mb-5">
      ...
      <div class="col-3 glass py-3 mx-4">
        <a class="text-decoration-none text-dark" href="{{ route('view',$post->id) }}">
          <h2>{{ $post->title }}</h2>
